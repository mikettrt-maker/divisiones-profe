...
const ENEMIES = {
  ...
  5:  { name:'El Verdugo Real',         jpg: GITHUB+'/El%20Verdugo%20Real.svg', story:'Fue el guardián más leal de la corona, tan fiel que siguió cumpliendo su deber cuando el reino ya no existía. Cada mañana barre la plaza, revisa las puertas del castillo y anuncia las horas con su campana, aunque nadie lo escucha. Dicen que espera el día en que el rey regrese a recompensarlo, y que quien lo saluda como a un igual recibe a la mañana siguiente un regalo en su puerta: una rosa de hierro que jamás se marchita.' },
