...
const ENEMIES = {
  ...
  5:  { name:'El Verdugo Real',         jpg: GITHUB+'/El%20Verdugo%20Real.svg', story:'Cumplió la última orden de un rey que ya estaba muerto: ejecutar a todo el reino. Su hacha no conoce la diferencia entre inocente y culpable, solo conoce la nuca que se le ofrece. Cuando no hay condenados, se ejecuta a sí mismo en sueños y despierta con las manos llenas de su propia sangre.' },
