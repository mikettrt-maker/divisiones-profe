...
const ENEMIES = {
  ...
  5:  { name:'El Verdugo Real',         jpg: GITHUB+'/El%20Verdugo%20Real.svg', story:'Cumplió la última orden de un rey que ya estaba muerto: la de no descansar jamás. Su hacha no conoce la diferencia entre inocente y culpable, solo conoce el deber que le fue encomendado. Dicen que cuando no hay nadie a quien vigilar, se sienta en su torre y cuenta las horas esperando una orden que nunca llega. El pueblo cruza la calle al verlo pasar y nadie recuerda haberlo visto sonreír.' },
